...
func _convert_material(mat: StandardMaterial3D) -> ShaderMaterial:
	...
	new_mat.set_shader_parameter("ao_texture_channel", _get_texture_mask(mat.ao_texture_channel))
	new_mat.set_shader_parameter("metallic_texture_channel", _get_texture_mask(mat.metallic_texture_channel))
